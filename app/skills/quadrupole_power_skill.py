...
from app.skills.integration.quadrupole_power_diagnosis import (
    QuadrupolePowerSkill as StandardQuadrupolePowerSkill,
)
from app.tools.registry import ToolRegistry

_DESCRIPTOR = load_skill_descriptor(
    Path(__file__).parent / "integration" / "quadrupole_power_diagnosis" / "SKILL.md"
)
...
class QuadrupolePowerSkill:
    ...
    def __init__(self) -> None:
        self._impl = StandardQuadrupolePowerSkill()
